                            ...
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="bg-[#ff9f22] text-white font-quicksand font-bold text-[11px] px-2.5 py-1.5 rounded-[6px] hover:bg-[#e6832b] disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-1"
                                    >
