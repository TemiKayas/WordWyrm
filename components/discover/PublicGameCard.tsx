...
const SnakeIcon = () => (
  <svg width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M6.5 0C4.84315 0 3.5 1.34315 3.5 3C3.5 4.65685 4.84315 6 6.5 6C8.15685 6 9.5 4.65685 9.5 3C9.5 1.34315 8.15685 0 6.5 0ZM2 7C0.89543 7 0 7.89543 0 9V12C0 13.6569 1.34315 15 3 15H10C11.6569 15 13 13.6569 13 12V9C13 7.89543 12.1046 7 11 7H2Z" fill="white"/>
  </svg>
);
