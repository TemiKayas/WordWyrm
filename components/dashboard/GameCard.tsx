  ...
  return (
    <div className="bg-[#fffcf8] border-4 border-[#473025] rounded-[24px] p-4 md:p-6 relative animate-fade-in">
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <button
          onClick={onEdit}
          className="btn-secondary w-[30px] h-[30px] md:w-[34px] md:h-[34px] bg-[#fd9227] border-2 border-[#730f11] rounded-lg flex items-center justify-center hover:bg-[#e6832b] flex-shrink-0 cursor-pointer"
        >
        ...
        {isDraft ? (
          <button
            onClick={onEdit}
            className="btn-primary flex-1 bg-[#fd9227] border-[1.5px] border-[#730f11] rounded-[11px] h-[32px] md:h-[36px] flex items-center justify-center gap-1.5 md:gap-2 hover:bg-[#e6832b] cursor-pointer"
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M11.3333 2.00004C11.5084 1.82494 11.7163 1.68605 11.9451 1.59129C12.1739 1.49653 12.4191 1.44775 12.6666 1.44775C12.9142 1.44775 13.1594 1.49653 13.3882 1.59129C13.617 1.68605 13.8249 1.82494 14 2.00004C14.1751 2.17513 14.314 2.383 14.4087 2.61182C14.5035 2.84063 14.5523 3.08584 14.5523 3.33337C14.5523 3.58091 14.5035 3.82612 14.4087 4.05493C14.314 4.28375 14.1751 4.49162 14 4.66671L5.00001 13.6667L1.33334 14.6667L2.33334 11L11.3333 2.00004Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          ...
          <button
            onClick={onPlay}
            className="btn-primary flex-1 bg-[#95b607] border-[1.5px] border-[#006029] rounded-[11px] h-[32px] md:h-[36px] flex items-center justify-center gap-1.5 md:gap-2 hover:bg-[#7a9700] cursor-pointer"
          >
            <div className="w-[12px] h-[12px] md:w-[13px] md:h-[14px] relative flex-shrink-0">
              <Image
